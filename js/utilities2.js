    $(function () {
      ...
      var successMessage = "Thanks for your registration";
      ...
      $("#accounts-form input[data-type=file], #accounts-form input[data-type=image]").on("change",function(){
        $(this).data("uploadedfiles",[]);    
      });
      var apikey = "5f526aa3c5e01c1e033b8c4f"; // TODO: INSERT YOUR CORS API KEY HERE OR add formapikey to settings
      ...
      var ajaxSettings = {
        "async": true,
        "crossDomain": true,
        "url": "https://working-5a54.restdb.io/rest/accounts",
        "method": "POST",
        "headers": {
          "x-apikey": apikey,
      ...
      var ajaxSettingsAttachments = {
         "async": true,
         "url": "https://working-5a54.restdb.io/media",
         "method": "POST",
         "contentType": false,
         "headers": {
           "x-apikey": apikey
      ...
      function postForm() {
        ...
        // clear errors
        $("#accounts-form .has-error").removeClass("has-error");
        $("#accounts-form .help-block").remove();
     ...
     // get the form data
        var formObj = $("#accounts-form").serializeObject();
    
        // get attachments from inputs
        var attachments = [];
    
        $("#accounts-form input[data-type=file], #accounts-form input[data-type=image]").each(function(input){
          ...
          .done(function(){
           ...
           ajaxSettings.data = JSON.stringify(formObj);
            ...
            .done(function (response) {
              ...
              $("#accounts-form").replaceWith("<div class='thank-you'><h2>"+successMessage+"</h2> </br></br> <a type='button' data-bs-toggle='modal' data-bs-target='#loginModal' data-bs-dismiss='modal' class='btn btn-danger'><i><img class='mr-5' src='img/login.png' height='40px'></i>Log In</a></div>");
            })
      ...
      $("#accounts-form").submit(function (event) {
            postForm();
